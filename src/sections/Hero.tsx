    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <div className="container" id="home">
        <div className="flex flex-col items-center">
          ...
          />
          <div className="bg-gray-100 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          <button className="inline-flex items-center gap-2 border border-gray-300 dark:border-white/15 px-6 h-12 rounded-xl">
            <span className="font-semibold">Explore My Work</span>
            <ArrowDown className="size-4" />
          </button>
          <button className="inline-flex items-center gap-2 bg-gray-900 text-white dark:bg-white dark:text-gray-900 h-12 px-6 rounded-xl">
            <span>👋</span>
